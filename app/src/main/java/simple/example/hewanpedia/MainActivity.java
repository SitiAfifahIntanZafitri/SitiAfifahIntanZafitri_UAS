...
public class MainActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        btnKucing.setOnClickListener(view -> bukaGaleri("Sungai"));
        btnAnjing.setOnClickListener(view -> bukaGaleri("Bukit"));
        btnBuaya.setOnClickListener(view -> bukaGaleri("Air Terjun"));
